...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      post1 = Post.create(date: Date.today, rationale: "asdsf", user_id: @user.id)
      post2 = Post.create(date: Date.today, rationale: "asdsf", user_id: @user.id)
  ...
  describe 'edit' do
    before do
      ...
      login_as(@edit_user, :scrope => :user)
      @edit_post = Post.create(date: Date.today, rationale: "asdf", user_id: test_user_id)
    end
